...
class SQLDataTypeEnum {
    companion object {
        fun sqlDataTypes() = listOf(
            "VARCHAR", "CHAR", "LONGVARCHAR", "CLOB", "NVARCHAR", "NCHAR", "LONGNVARCHAR",
            "NCLOB", "BOOLEAN", "BIT", "TINYINT", "SMALLINT", "INTEGER", "BIGINT", "DECIMAL_INTEGER",
            "TINYINTUNSIGNED", "SMALLINTUNSIGNED", "INTEGERUNSIGNED", "BIGINTUNSIGNED", "DOUBLE",
            "FLOAT", "REAL", "NUMERIC", "DECIMAL", "DATE", "TIMESTAMP", "TIME", "INTERVAL",
            "INTERVALYEARTOMONTH", "INTERVALDAYTOSECOND", "LOCALTIME", "LOCALDATETIME",
            "OFFSETTIME", "OFFSETDATETIME", "TIMEWITHTIMEZONE", "TIMESTAMPWITHTIMEZONE",
            "INSTANT", "BINARY", "VARBINARY", "LONGVARBINARY", "BLOB", "OTHER", "ROWID",
            "RECORD", "RESULT", "UUID", "JSON", "JSONB"
        )

        fun getSqlDateType() = listOf(
            "DATE", "TIMESTAMP", "TIME", "INTERVAL",
            "INTERVALYEARTOMONTH", "INTERVALDAYTOSECOND", "LOCALTIME",
            "LOCALDATETIME", "OFFSETTIME", "OFFSETDATETIME",
            "TIMEWITHTIMEZONE", "TIMESTAMPWITHTIMEZONE", "INSTANT"
        )
